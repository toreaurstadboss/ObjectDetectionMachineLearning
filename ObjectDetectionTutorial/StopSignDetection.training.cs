...
namespace ObjectDetectionTutorial
{
    ...
    {
        public const string RetrainFilePath = @"C:\src\MLNetHelpers\ObjectDetectionTutorial\data\images\stop-signs\vott-json-export\StopSignObjDetection-export.json";
